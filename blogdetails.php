    ...
    <div class="main-container">
        ...
        <header>
            <h1>Boost Business Productivity with these Tips</h1>
            <p class="date">January, 7th, 2021</p>
        </header>

        <div class="content-wrapper">
            <main class="blog-content">
                <p><strong>Here are 5 ways to boost business productivity:</strong></p>
                <p><strong>1. Get rid of clutter, and take care of your workplace environment</strong></p>
                <p>The most straightforward way is to tidy up the office space.</p>
                <p><a href="#">Studies</a> have demonstrated that our physical environment has a significant effect on the way that we work, think and behave. When the environment is in a mess, so are we.</p>
                <p><a href="#">Clutter can also affect general mental health</a>, stirring feelings of stress, anxiety, or depression. In a clutter-free environment, people are able to focus better and their productivity increases.</p>
                <p>Very often, office desks are littered with tons of paper — invoices, physical receipts from transport, claims… the list goes on. Not just that, an organised space also makes it easier for you to find the documents that you actually need.</p>
