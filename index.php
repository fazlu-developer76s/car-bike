            ...
            <div class="input-group">
              <div class="input-icon">
                <svg class="icon" fill="currentColor" viewBox="0 0 20 20">
                  <path fill-rule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9 7 7 0 01-9.9-9.9zM10 18a8 8 0 100-16 8 8 0 000 16zm-1-9a1 1 0 112 0v2a1 1 0 11-2 0v-2zm0-4a1 1 0 112 0 1 1 0 01-2 0z" clip-rule="evenodd"></path>
                </svg>
              </div>
              <input type="text" placeholder="Enter Pickup Location" class="input-field"/>
            </div>
            <div class="input-group">
              <div class="input-icon">
                <svg class="icon" fill="currentColor" viewBox="0 0 20 20">
              ...
              <input type="text" placeholder="Enter Drop Location" class="input-field"/>
            </div>
          ...
          <div class="services-grid">
            <div class="service-card">
              <div class="service-card-image-wrapper">
                <img src="assets/images/bike.PNG" alt="Bike" class="service-image"/>
              </div>
              <h3 class="service-card-title">Bike</h3>
            </div>
            <div class="service-card">
              <div class="service-card-image-wrapper">
                <img src="assets/images/auto.PNG" alt="Auto" class="service-image"/>
              </div>
              <h3 class="service-card-title">Auto</h3>
            </div>
            <div class="service-card">
              <div class="service-card-image-wrapper">
                <img src="assets/images/autoshare.PNG" alt="Auto Share" class="service-image"/>
              </div>
              <h3 class="service-card-title">Auto Share</h3>
            </div>
            <div class="service-card">
              <div class="service-card-image-wrapper">
                <img src="assets/images/parcel.PNG" alt="Parcel" class="service-image"/>
              </div>
              <h3 class="service-card-title">Parcel</h3>
            </div>
            <div class="service-card">
              <div class="service-card-image-wrapper">
                <img src="assets/images/cab economy.PNG" alt="Cab Economy" class="service-image"/>
              </div>
              <h3 class="service-card-title">Cab Economy</h3>
            </div>
            <div class="service-card">
              <div class="service-card-image-wrapper">
                <img src="assets/images/cab premimum.PNG" alt="Cab Premium" class="service-image"/>
              </div>
